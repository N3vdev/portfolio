 ...
 */var zu;function Id(){if(zu)return q;zu=1;var v=Symbol.for("react.element"),w=Symbol.for("react.portal"),p=Symbol.for("react.fragment"),C=Symbol.for("react.strict_mode"),_=Symbol.for("react.profiler"),R=Symbol.for("react.provider"),G=Symbol.for("react.context"),X=Symbol.for("react.forward_ref"),B=Symbol.for("react.suspense"),Z=Symbol.for("react.memo"),K=Symbol.for("react.lazy"),ne=Symbol.iterator;function W(d){return d===null||typeof d!="object"?null:(d=ne&&d[ne]||d["@@iterator"],typeof d=="function"?d:null)}var re={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},U=Object.assign,$={};function D(d,y,J){this.props=d,this.context=y,this.refs=$,this.updater=J||re}D.prototype.isReactComponent={},D.prototype.setState=function(d,y){if(typeof d!="object"&&typeof d!="function"&&d!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,d,y,"setState")},D.prototype.forceUpdate=function(d){this.updater.enqueueForceUpdate(this,d,"forceUpdate")};function ke(){}ke.prototype=D.prototype;function ee(d,y,J){this.props=d,this.context=y,this.refs=$,this.updater=J||re}var Q=ee.prototype=new ke;Q.constructor=ee,U(Q,D.prototype),Q.isPureReactComponent=!0;var I=Array.isArray,ue=Object.prototype.hasOwnProperty,V={current:null},fe={key:!0,ref:!0,__self:!0,__source:!0};function be(d,y,J){var te,oe={},se=null,pe=null;if(y!=null)for(te in y.ref!==void 0&&(pe=y.ref),y.key!==void 0&&(se=""+y.key),y)ue.call(y,te)&&!fe.hasOwnProperty(te)&&(oe[te]=y[te]);var ce=arguments.length-2;if(ce===1)oe.children=J;else if(1<ce){for(var ve=Array(ce),Ge=0;Ge<ce;Ge++)ve[Ge]=arguments[Ge+2];oe.children=ve}if(d&&d.defaultProps)for(te in ce=d.defaultProps,ce)oe[te]===void 0&&(oe[te]=ce[te]);return{$$typeof:v,type:d,key:se,ref:pe,props:oe,_owner:V.current}}function Ne(d,y){return{$$typeof:v,type:d.type,key:y,ref:d.ref,props:d.props,_owner:d._owner}}function Fe(d){return typeof d=="object"&&d!==null&&d.$$typeof===v}function wt(d){var y={"=":"=0",":":"=2"};return"$"+d.replace(/[=:]/g,function(J){return y[J]})}var tt=/\/+/g;function De(d,y){return typeof d=="object"&&d!==null&&d.key!=null?wt(""+d.key):y.toString(36)}function $e(d,y,J,te,oe){var se=typeof d;(se==="undefined"||se==="boolean")&&(d=null);var pe=!1;if(d===null)pe=!0;else switch(se){case"string":case"number":pe=!0;break;case"object":switch(d.$$typeof){case v:case w:pe=!0}}if(pe)return pe=d,oe=oe(pe),d=te===""?"."+De(pe,0):te,I(oe)?(J="",d!=null&&(J=d.replace(tt,"$&/")+"/"),$e(oe,y,J,"",function(Ge){return Ge})):oe!=null&&(Fe(oe)&&(oe=Ne(oe,J+(!oe.key||pe&&pe.key===oe.key?"":(""+oe.key).replace(tt,"$&/")+"/")+d)),y.push(oe)),1;if(pe=0,te=te===""?".":te+":",I(d))for(var ce=0;ce<d.length;ce++){se=d[ce];var ve=te+De(se,ce);pe+=$e(se,y,J,ve,oe)}else if(ve=W(d),typeof ve=="function")for(d=ve.call(d),ce=0;!(se=d.next()).done;)se=se.value,ve=te+De(se,ce++),pe+=$e(se,y,J,ve,oe);else if(se==="object")throw y=String(d),Error("Objects are not valid as a React child (found: "+(y==="[object Object]"?"object with keys {"+Object.keys(d).join(", ")+"}":y)+"). If you meant to render a collection of children, use an array instead.");return pe}function S(d,y,J){if(d==null)return d;var te=[],oe=0;return $e(d,te,"","",function(se){return y.call(J,se,oe++)}),te}function H(d){if(d._status===-1){var y=d._result;y=y(),y.then(function(J){(d._status===0||d._status===-1)&&(d._status=1,d._result=J)},function(J){(d._status===0||d._status===-1)&&(d._status=2,d._result=J)}),d._status===-1&&(d._status=0,d._result=y)}if(d._status===1)return d._result.default;throw d._result}var le={current:null},E={transition:null},F={ReactCurrentDispatcher:le,ReactCurrentBatchConfig:E,ReactCurrentOwner:V};function j(){throw Error("act(...) is not supported in production builds of React.")}return q.Children={map:S,forEach:function(d,y,J){S(d,function(){y.apply(this,arguments)},J)},count:function(d){var y=0;return S(d,function(){y++}),y},toArray:function(d){return S(d,function(y){return y})||[]},only:function(d){if(!Fe(d))throw Error("React.Children.only expected to receive a single React element child.");return d}},q.Component=D,q.Fragment=p,q.Profiler=_,q.PureComponent=ee,q.StrictMode=C,q.Suspense=B,q.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=F,q.act=j,q.cloneElement=function(d,y,J){if(d==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+d+".");var te=U({},d.props),oe=d.key,se=d.ref,pe=d._owner;if(y!=null){if(y.ref!==void 0&&(se=y.ref,pe=V.current),y.key!==void 0&&(oe=""+y.key),d.type&&d.type.defaultProps)var ce=d.type.defaultProps;for(ve in y)ue.call(y,ve)&&!fe.hasOwnProperty(ve)&&(te[ve]=y[ve]===void 0&&ce!==void 0?ce[ve]:y[ve])}var ve=arguments.length-2;if(ve===1)te.children=J;else if(1<ve){ce=Array(ve);for(var Ge=0;Ge<ve;Ge++)ce[Ge]=arguments[Ge+2];te.children=ce}return{$$typeof:v,type:d.type,key:oe,ref:se,props:te,_owner:pe}},q.createContext=function(d){return d={$$typeof:G,_currentValue:d,_currentValue2:d,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},d.Provider={$$typeof:R,_context:d},d.Consumer=d},q.createElement=be,q.createFactory=function(d){var y=be.bind(null,d);return y.type=d,y},q.createRef=function(){return{current:null}},q.forwardRef=function(d){return{$$typeof:X,render:d}},q.isValidElement=Fe,q.lazy=function(d){return{$$typeof:K,_payload:{_status:-1,_result:d},_init:H}},q.memo=function(d,y){return{$$typeof:Z,type:d,compare:y===void 0?null:y}},q.startTransition=function(d){var y=E.transition;E.transition={};try{d()}finally{E.transition=y}},q.unstable_act=j,q.useCallback=function(d,y){return le.current.useCallback(d,y)},q.useContext=function(d){return le.current.useContext(d)},q.useDebugValue=function(){},q.useDeferredValue=function(d){return le.current.useDeferredValue(d)},q.useEffect=function(d,y){return le.current.useEffect(d,y)},q.useId=function(){return le.current.useId()},q.useImperativeHandle=function(d,y,J){return le.current.useImperativeHandle(d,y,J)},q.useInsertionEffect=function(d,y){return le.current.useInsertionEffect(d,y)},q.useLayoutEffect=function(d,y){return le.current.useLayoutEffect(d,y)},q.useMemo=function(d,y){return le.current.useMemo(d,y)},q.useReducer=function(d,y,J){return le.current.useReducer(d,y,J)},q.useRef=function(d){return le.current.useRef(d)},q.useState=function(d){return le.current.useState(d)},q.useSyncExternalStore=function(d,y,J){return le.current.useSyncExternalStore(d,y,J)},q.useTransition=function(){return le.current.useTransition()},q.version="18.3.1",q}var _u;function To(){return _u||(_u=1,No.exports=Id()),No.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Pu;function Od(){if(Pu)return wr;Pu=1;var v=To(),w=Symbol.for("react.element"),p=Symbol.for("react.fragment"),C=Object.prototype.hasOwnProperty,_=v.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,R={key:!0,ref:!0,__self:!0,__source:!0};function G(X,B,Z){var K,ne={},W=null,re=null;Z!==void 0&&(W=""+Z),B.key!==void 0&&(W=""+B.key),B.ref!==void 0&&(re=B.ref);for(K in B)C.call(B,K)&&!R.hasOwnProperty(K)&&(ne[K]=B[K]);if(X&&X.defaultProps)for(K in B=X.defaultProps,B)ne[K]===void 0&&(ne[K]=B[K]);return{$$typeof:w,type:X,key:W,ref:re,props:ne,_owner:_.current}}return wr.Fragment=p,wr.jsx=G,wr.jsxs=G,wr}var Lu;function Ad(){return Lu||(Lu=1,Co.exports=Od()),Co.exports}var s=Ad(),N=To(),Li={},zo={exports:{}},Ke={},_o={exports:{}},Po={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Mu;function Bd(){return Mu||(Mu=1,(function(v){function w(E,F){var j=E.length;E.push(F);e:for(;0<j;){var d=j-1>>>1,y=E[d];if(0<_(y,F))E[d]=F,E[j]=y,j=d;else break e}}function p(E){return E.length===0?null:E[0]}function C(E){if(E.length===0)return null;var F=E[0],j=E.pop();if(j!==F){E[0]=j;e:for(var d=0,y=E.length,J=y>>>1;d<J;){var te=2*(d+1)-1,oe=E[te],se=te+1,pe=E[se];if(0>_(oe,j))se<y&&0>_(pe,oe)?(E[d]=pe,E[se]=j,d=se):(E[d]=oe,E[te]=j,d=te);else if(se<y&&0>_(pe,j))E[d]=pe,E[se]=j,d=se;else break e}}return F}function _(E,F){var j=E.sortIndex-F.sortIndex;return j!==0?j:E.id-F.id}if(typeof performance=="object"&&typeof performance.now=="function"){var R=performance;v.unstable_now=function(){return R.now()}}else{var G=Date,X=G.now();v.unstable_now=function(){return G.now()-X}}var B=[],Z=[],K=1,ne=null,W=3,re=!1,U=!1,$=!1,D=typeof setTimeout=="function"?setTimeout:null,ke=typeof clearTimeout=="function"?clearTimeout:null,ee=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function Q(E){for(var F=p(Z);F!==null;){if(F.callback===null)C(Z);else if(F.startTime<=E)C(Z),F.sortIndex=F.expirationTime,w(B,F);else break;F=p(Z)}}function I(E){if($=!1,Q(E),!U)if(p(B)!==null)U=!0,H(ue);else{var F=p(Z);F!==null&&le(I,F.startTime-E)}}function ue(E,F){U=!1,$&&($=!1,ke(be),be=-1),re=!0;var j=W;try{for(Q(F),ne=p(B);ne!==null&&(!(ne.expirationTime>F)||E&&!wt());){var d=ne.callback;if(typeof d=="function"){ne.callback=null,W=ne.priorityLevel;var y=d(ne.expirationTime<=F);F=v.unstable_now(),typeof y=="function"?ne.callback=y:ne===p(B)&&C(B),Q(F)}else C(B);ne=p(B)}if(ne!==null)var J=!0;else{var te=p(Z);te!==null&&le(I,te.startTime-F),J=!1}return J}finally{ne=null,W=j,re=!1}}var V=!1,fe=null,be=-1,Ne=5,Fe=-1;function wt(){return!(v.unstable_now()-Fe<Ne)}function tt(){if(fe!==null){var E=v.unstable_now();Fe=E;var F=!0;try{F=fe(!0,E)}finally{F?De():(V=!1,fe=null)}}else V=!1}var De;if(typeof ee=="function")De=function(){ee(tt)};else if(typeof MessageChannel<"u"){var $e=new MessageChannel,S=$e.port2;$e.port1.onmessage=tt,De=function(){S.postMessage(null)}}else De=function(){D(tt,0)};function H(E){fe=E,V||(V=!0,De())}function le(E,F){be=D(function(){E(v.unstable_now())},F)}v.unstable_IdlePriority=5,v.unstable_ImmediatePriority=1,v.unstable_LowPriority=4,v.unstable_NormalPriority=3,v.unstable_Profiling=null,v.unstable_UserBlockingPriority=2,v.unstable_cancelCallback=function(E){E.callback=null},v.unstable_continueExecution=function(){U||re||(U=!0,H(ue))},v.unstable_forceFrameRate=function(E){0>E||125<E?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Ne=0<E?Math.floor(1e3/E):5},v.unstable_getCurrentPriorityLevel=function(){return W},v.unstable_getFirstCallbackNode=function(){return p(B)},v.unstable_next=function(E){switch(W){case 1:case 2:case 3:var F=3;break;default:F=W}var j=W;W=F;try{return E()}finally{W=j}},v.unstable_pauseExecution=function(){},v.unstable_requestPaint=function(){},v.unstable_runWithPriority=function(E,F){switch(E){case 1:case 2:case 3:case 4:case 5:break;default:E=3}var j=W;W=E;try{return F()}finally{W=j}},v.unstable_scheduleCallback=function(E,F,j){var d=v.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?d+j:d):j=d,E){case 1:var y=-1;break;case 2:y=250;break;case 5:y=1073741823;break;case 4:y=1e4;break;default:y=5e3}return y=j+y,E={id:K++,callback:F,priorityLevel:E,startTime:j,expirationTime:y,sortIndex:-1},j>d?(E.sortIndex=j,w(Z,E),p(B)===null&&E===p(Z)&&($?(ke(be),be=-1):$=!0,le(I,j-d))):(E.sortIndex=y,w(B,E),U||re||(U=!0,H(ue))),E},v.unstable_shouldYield=wt,v.unstable_wrapCallback=function(E){var F=W;return function(){var j=W;W=F;try{return E.apply(this,arguments)}finally{W=j}}}})(Po)),Po}var Tu;function Ud(){return Tu||(Tu=1,_o.exports=Bd()),_o.exports}/**
 * @license React
...
`,Qd=["home","about","projects"];function Xd({active:v,onNav:w}){const[p,C]=N.useState(!1),[_,R]=N.useState(!1),[G,X]=N.useState(!1),B=N.useRef(null),Z=N.useRef({}),[K,ne]=N.useState({x:0,w:0,ready:!1});N.useEffect(()=>{const U=()=>C(window.scrollY>50);return window.addEventListener("scroll",U),()=>window.removeEventListener("scroll",U)},[]),N.useEffect(()=>{const U=$=>X($.detail);return window.addEventListener("lock-scroll",U),()=>window.removeEventListener("lock-scroll",U)},[]);const W=N.useCallback(()=>{const U=v==="hero"?"home":v,$=Z.current[U],D=B.current;if(!$||!D)return;const ke=$.getBoundingClientRect(),ee=D.getBoundingClientRect();ne({x:ke.left-ee.left,w:ke.width,ready:!0})},[v]);N.useEffect(()=>{W()},[W]),N.useEffect(()=>(window.addEventListener("resize",W),()=>window.removeEventListener("resize",W)),[W]);const re=U=>{w==null||w(U),R(!1)};return s.jsxs(s.Fragment,{children:[s.jsx("style",{children:`
        .nav {
...
`;function af(v){const w=v.getContext("webgl")||v.getContext("experimental-webgl");if(!w)return null;const p=(G,X)=>{const B=w.createShader(G);return w.shaderSource(B,X),w.compileShader(B),B},C=w.createProgram();w.attachShader(C,p(w.VERTEX_SHADER,of)),w.attachShader(C,p(w.FRAGMENT_SHADER,sf)),w.linkProgram(C),w.useProgram(C);const _=w.createBuffer();w.bindBuffer(w.ARRAY_BUFFER,_),w.bufferData(w.ARRAY_BUFFER,new Float32Array([-1,-1,1,-1,-1,1,1,1]),w.STATIC_DRAW);const R=w.getAttribLocation(C,"a_pos");return w.enableVertexAttribArray(R),w.vertexAttribPointer(R,2,w.FLOAT,!1,0,0),{gl:w,uRes:w.getUniformLocation(C,"u_res"),uTime:w.getUniformLocation(C,"u_time"),uMouse:w.getUniformLocation(C,"u_mouse"),uSx:[0,1,2,3,4,5].map(G=>w.getUniformLocation(C,`u_sx${G}`))}}function uf(v){return[0,-.38,.38,-.38][v]??0}function cf({sectionIndex:v,loaded:w=!1}){const p=N.useRef(null),C=N.useRef(null),_=N.useRef({x:0,y:0}),R=N.useRef({x:0,y:0}),G=N.useRef(0),X=N.useRef([0,0,0,0,0,0]),B=N.useRef();return N.useEffect(()=>{G.current=uf(v)},[v]),N.useEffect(()=>{const Z=p.current;C.current=af(Z);const K=()=>{var $;Z.width=window.innerWidth,Z.height=window.innerHeight,($=C.current)==null||$.gl.viewport(0,0,Z.width,Z.height)};K(),window.addEventListener("resize",K);const ne=$=>{R.current={x:$.clientX,y:$.clientY}},W=$=>{R.current={x:$.touches[0].clientX,y:$.touches[0].clientY}};window.addEventListener("mousemove",ne),window.addEventListener("touchmove",W,{passive:!0});const re=[.055,.038,.028,.02,.015,.011],U=$=>{_.current.x+=(R.current.x-_.current.x)*.06,_.current.y+=(R.current.y-_.current.y)*.06;const D=X.current;D[0]+=(G.current-D[0])*re[0];for(let ee=1;ee<6;ee++)D[ee]+=(D[ee-1]-D[ee])*re[ee];const ke=C.current;if(ke){const{gl:ee,uRes:Q,uTime:I,uMouse:ue,uSx:V}=ke;ee.uniform2f(Q,Z.width,Z.height),ee.uniform1f(I,$*.001),ee.uniform2f(ue,_.current.x,Z.height-_.current.y);for(let fe=0;fe<6;fe++)ee.uniform1f(V[fe],D[fe]);ee.drawArrays(ee.TRIANGLE_STRIP,0,4)}B.current=requestAnimationFrame(U)};return B.current=requestAnimationFrame(U),()=>{window.removeEventListener("resize",K),window.removeEventListener("mousemove",ne),window.removeEventListener("touchmove",W),cancelAnimationFrame(B.current)}},[]),s.jsx("canvas",{ref:p,style:{position:"fixed",inset:0,width:"100%",height:"100%",zIndex:0,pointerEvents:"none",transform:w?"scale(1)":"scale(3)",transition:w?"transform 1.5s cubic-bezier(0.22, 1, 0.36, 1) 0.9s":"none",transformOrigin:"center center"}})}const Xt=["hero","about","projects","contact"],Rn=900,df=950,ff=30;function pf(){const[v,w]=N.useState(!1),[p,C]=N.useState(0),[_,R]=N.useState(null),[G,X]=N.useState(1),[B,Z]=N.useState(!1),[K,ne]=N.useState(!1),W=N.useRef(!1),re=N.useRef(null),U=N.useRef(0),$=N.useRef(null);N.useEffect(()=>{const Q=I=>ne(I.detail);return window.addEventListener("lock-scroll",Q),()=>window.removeEventListener("lock-scroll",Q)},[]),N.useEffect(()=>{const Q=Mo.filter(V=>V.image).map(V=>new Promise(fe=>{const be=new Image;be.onload=fe,be.onerror=fe,be.src=V.image})),I=new Promise(V=>setTimeout(V,1500)),ue=document.fonts?document.fonts.ready:Promise.resolve();Promise.all([I,ue,...Q]).then(()=>w(!0))},[]);const D=N.useCallback(Q=>{if(K)return;const I=Math.max(0,Math.min(Xt.length-1,Q));I===p||W.current||(W.current=!0,X(I>p?1:-1),R(p),C(I),Z(!0),setTimeout(()=>{R(null),Z(!1),W.current=!1},df))},[p,K]);N.useEffect(()=>{const Q=I=>{if(!K){if(I.preventDefault(),W.current){U.current=0,clearTimeout($.current);return}U.current+=I.deltaY,clearTimeout($.current),$.current=setTimeout(()=>{U.current=0},200),Math.abs(U.current)>=ff&&(D(p+(U.current>0?1:-1)),U.current=0)}};return window.addEventListener("wheel",Q,{passive:!1}),()=>window.removeEventListener("wheel",Q)},[D,p,K]),N.useEffect(()=>{const Q=ue=>{K||(re.current=ue.touches[0].clientY)},I=ue=>{if(K||re.current===null)return;const V=re.current-ue.changedTouches[0].clientY;Math.abs(V)>40&&D(p+(V>0?1:-1)),re.current=null};return window.addEventListener("touchstart",Q,{passive:!0}),window.addEventListener("touchend",I,{passive:!0}),()=>{window.removeEventListener("touchstart",Q),window.removeEventListener("touchend",I)}},[D,p,K]),N.useEffect(()=>{const Q=I=>{K||((I.key==="ArrowDown"||I.key==="PageDown")&&D(p+1),(I.key==="ArrowUp"||I.key==="PageUp")&&D(p-1))};return window.addEventListener("keydown",Q),()=>window.removeEventListener("keydown",Q)},[D,p,K]),N.useEffect(()=>{const Q=I=>{const ue=Xt.indexOf(I.detail);ue!==-1&&D(ue)};return window.addEventListener("snapto",Q),()=>window.removeEventListener("snapto",Q)},[D]);const ke=N.useCallback(Q=>{const I=Xt.indexOf(Q);I!==-1&&D(I)},[D]),ee=[s.jsx(Zd,{loaded:v},"hero"),s.jsx(tf,{},"about"),s.jsx(nf,{isActive:p===Xt.indexOf("projects")},"projects"),s.jsx(rf,{},"contact")];return s.jsxs(s.Fragment,{children:[s.jsx("style",{children:Yd}),s.jsx("style",{children:`
      ...
      `}),s.jsx(cf,{sectionIndex:p,loaded:v}),s.jsx(lf,{done:v}),s.jsx("div",{className:"scroll-progress",style:{width:`${p/(Xt.length-1)*100}%`,opacity:v?1:0,transition:`opacity 0.6s ease, width ${Rn}ms cubic-bezier(0.76,0,0.24,1)`}}),s.jsx("div",{className:"scroll-dots",style:{opacity:v?1:0,transition:"opacity 0.6s ease"},children:Xt.map((Q,I)=>s.jsx("div",{className:`scroll-dot${I===p?" on":""}`,onClick:()=>D(I),title:Q.charAt(0).toUpperCase()+Q.slice(1)},Q))}),s.jsx("div",{style:{opacity:v?1:0,transition:"opacity 0.6s ease",position:"relative",zIndex:K?0:1e3},children:s.jsx(Xd,{active:Xt[p],onNav:ke})}),s.jsx("div",{className:"snap-root",style:{opacity:v?1:0,transition:"opacity 0.7s cubic-bezier(0.22, 1, 0.36, 1)",zIndex:K?2e3:0},children:ee.map((Q,I)=>{const ue=I===p,V=I===_;let fe="snap-page";return ue?fe+=B?` is-enter${G===-1?" from-above":""}`:" is-active":V&&(fe+=` is-exit${G===-1?" to-below":""}`),s.jsx("div",{className:fe,style:{zIndex:ue?2:V?1:0},children:Q},Xt[I])})})]})}Hd.createRoot(document.getElementById("root")).render(s.jsx(N.StrictMode,{children:s.jsx(pf,{})}));
